...
class Yb173_S25_HighN(FModel):
    ...
    inner_channels = [
        ...
        AngularKetDummyFJ(f_tot=2.5, name="4f13 5d 6snl a", species="Yb173"),
        AngularKetLS(l_c=1, l_r=1, l_tot=0, s_tot=0, j_tot=0, f_tot=2.5, species="Yb173"),  # "6pnp 1S0"
        AngularKetDummyFJ(f_tot=2.5, name="4f13 5d 6snl b", species="Yb173"),
        AngularKetLS(l_c=1, l_r=1, l_tot=1, s_tot=1, j_tot=0, f_tot=2.5, species="Yb173"),  # "6pnp 3P0"
        AngularKetDummyFJ(f_tot=2.5, name="4f13 5d 6snl c", species="Yb173"),
    ...
    outer_channels = [
        ...
        AngularKetDummyFJ(f_tot=2.5, name="4f13 5d 6snl b", species="Yb173"),
        AngularKetDummyFJ(
            l_c=1, l_r=1, j_c=0.5, j_r=0.5, f_tot=2.5, name="f_c unknown", species="Yb173"
...
class Yb173_P05_HighN(FModel):
    ...
    inner_channels = [
        ...
        AngularKetDummyFJ(f_tot=0.5, name="4f13 5d 6snl a", species="Yb173"),
        AngularKetDummyFJ(f_tot=0.5, name="4f13 5d 6snl b", species="Yb173"),
        AngularKetDummyFJ(f_tot=0.5, name="4f13 5d 6snl c", species="Yb173"),
    ]
    outer_channels = [
...
class Yb173_P15_HighN(FModel):
    ...
    inner_channels = [
        ...
        AngularKetDummyFJ(f_tot=1.5, name="4f13 5d 6snl a", species="Yb173"),
        AngularKetDummyFJ(f_tot=1.5, name="4f13 5d 6snl b", species="Yb173"),
        AngularKetDummyFJ(f_tot=1.5, name="4f13 5d 6snl c", species="Yb173"),
        AngularKetDummyFJ(f_tot=1.5, name="4f13 5d 6snl d", species="Yb173"),
        AngularKetLS(l_c=0, l_r=1, l_tot=1, s_tot=1, j_tot=2, f_tot=1.5, species="Yb173"),  # "6snp 3P2"
        AngularKetDummyFJ(f_tot=1.5, name="4f13 5d 6snl e", species="Yb173"),
        AngularKetDummyFJ(f_tot=1.5, name="4f13 5d 6snl f", species="Yb173"),
        AngularKetDummyFJ(f_tot=1.5, name="4f13 5d 6snl g", species="Yb173"),
    ]
    outer_channels = [
...
class Yb173_P25_HighN(FModel):
    ...
    inner_channels = [
        ...
        AngularKetDummyFJ(f_tot=2.5, name="4f13 5d 6snl b", species="Yb173"),
        AngularKetDummyFJ(f_tot=2.5, name="4f13 5d 6snl c", species="Yb173"),
        AngularKetDummyFJ(f_tot=2.5, name="4f13 5d 6snl d", species="Yb173"),
        AngularKetLS(l_c=0, l_r=1, l_tot=1, s_tot=1, j_tot=0, f_tot=2.5, species="Yb173"),  # "6snp 3P0"
        AngularKetDummyFJ(f_tot=2.5, name="4f13 5d 6snl e", species="Yb173"),
        AngularKetLS(l_c=0, l_r=1, l_tot=1, s_tot=1, j_tot=2, f_tot=2.5, species="Yb173"),  # "6snp 3P2"
        AngularKetDummyFJ(f_tot=2.5, name="4f13 5d 6snl f", species="Yb173"),
        AngularKetDummyFJ(f_tot=2.5, name="4f13 5d 6snl g", species="Yb173"),
        AngularKetDummyFJ(f_tot=2.5, name="4f13 5d 6snl h", species="Yb173"),
    ]
    outer_channels = [
...
class Yb173_P35_HighN(FModel):
    ...
    inner_channels = [
        ...
        AngularKetDummyFJ(f_tot=3.5, name="4f13 5d 6snl a", species="Yb173"),
        AngularKetDummyFJ(f_tot=3.5, name="4f13 5d 6snl b", species="Yb173"),
        AngularKetDummyFJ(f_tot=3.5, name="4f13 5d 6snl c", species="Yb173"),
        AngularKetDummyFJ(f_tot=3.5, name="4f13 5d 6snl d", species="Yb173"),
        AngularKetLS(l_c=0, l_r=1, l_tot=1, s_tot=1, j_tot=2, f_tot=3.5, species="Yb173"),  # "6snp 3P2"
        AngularKetDummyFJ(f_tot=3.5, name="4f13 5d 6snl e", species="Yb173"),
        AngularKetDummyFJ(f_tot=3.5, name="4f13 5d 6snl f", species="Yb173"),
        AngularKetDummyFJ(f_tot=3.5, name="4f13 5d 6snl g", species="Yb173"),
    ]
    outer_channels = [
...
class Yb173_P45_HighN(FModel):
    ...
    inner_channels = [
        ...
        AngularKetDummyFJ(f_tot=4.5, name="4f13 5d 6snl a", species="Yb173"),
        AngularKetDummyFJ(f_tot=4.5, name="4f13 5d 6snl b", species="Yb173"),
        AngularKetDummyFJ(f_tot=4.5, name="4f13 5d 6snl c", species="Yb173"),
    ]
    outer_channels = [
